...
def download_and_extract_mnist(file_name, url, target_folder):
    ...
    with gzip.open(file_path, 'rb') as f_in:
        with open(file_path.replace('.gz', ''), 'wb') as f_out:
            ...
            print(f"Extraction terminée pour {file_name}.")

mnist_folder = "mnist"
os.makedirs(mnist_folder, exist_ok=True)

download_and_extract_mnist("train-images-idx3-ubyte.gz", "http://yann.lecun.com/exdb/mnist/train-images-idx3-ubyte.gz", mnist_folder)
download_and_extract_mnist("train-labels-idx1-ubyte.gz", "http://yann.lecun.com/exdb/mnist/train-labels-idx1-ubyte.gz", mnist_folder)
download_and_extract_mnist("t10k-images-idx3-ubyte.gz", "http://yann.lecun.com/exdb/mnist/t10k-images-idx3-ubyte.gz", mnist_folder)
download_and_extract_mnist("t10k-labels-idx1-ubyte.gz", "http://yann.lecun.com/exdb/mnist/t10k-labels-idx1-ubyte.gz", mnist_folder)
...
mnist_folder = "mnist"
X_train = idx2numpy.convert_from_file(os.path.join(mnist_folder, 'train-images-idx3-ubyte'))
y_train = idx2numpy.convert_from_file(os.path.join(mnist_folder, 'train-labels-idx1-ubyte'))
X_test = idx2numpy.convert_from_file(os.path.join(mnist_folder, 't10k-images-idx3-ubyte'))
y_test = idx2numpy.convert_from_file(os.path.join(mnist_folder, 't10k-labels-idx1-ubyte'))
